    ...
    public function add_product() {
        ...
        if ($result) {
            ...
            wp_send_json_success(array(
                ...
                'redirect' => admin_url('admin.php?page=raju-stock-management&rsm_message=product_added')
            ));
        } else {
    ...
    public function update_product() {
        ...
        if ($result !== false) {
            wp_send_json_success(array(
                ...
                'redirect' => admin_url('admin.php?page=raju-stock-management&rsm_message=product_updated')
            ));
        } else {
